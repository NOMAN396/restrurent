...
<form class="form" method="post" enctype="multipart/form-data"
            action="{{ route('fontendbookings.update', encryptor('encrypt', $fbookingtable->id)) }}">
            @csrf
            @method('PATCH')
...
value="{{ old('name',$fbookingtable->name) }}" name="name">
@if ($errors->has('name'))
...
value="{{ old('email',$fbookingtable->email) }}" name="email">
@if ($errors->has('name'))
<span class="text-danger"> {{ $errors->first('name') }}</span>
@endif
</div>
...
<input type="text" id="quentity" class="form-control"
value="{{ old('phone',$fbookingtable->phone) }}" name="phone">
@if ($errors->has('name'))
<span class="text-danger"> {{ $errors->first('name') }}</span>
@endif
</div>
...
value="{{ old('date',$fbookingtable->date) }}" name="date">
@if ($errors->has('name'))
<span class="text-danger"> {{ $errors->first('name') }}</span>
@endif
</div>
...
<input type="text" id="quentity" class="form-control"
value="{{ old('time',$fbookingtable->time) }}" name="time">
@if ($errors->has('name'))
<span class="text-danger"> {{ $errors->first('name') }}</span>
@endif
</div>
...
<input type="text" id="quentity" class="form-control"
value="{{ old('people',$fbookingtable->people) }}" name="people">
@if ($errors->has('name'))
<span class="text-danger"> {{ $errors->first('name') }}</span>
@endif
</div>
