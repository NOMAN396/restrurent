...
action="{{ route('orderlists.store') }}">
@csrf
<!-- <div class="form-group">
<label for="name">Table no <i class="text-danger">*</i></label>
<input type="text" id="table_no" class="form-control"
value="{{ old('table_no') }}" name="table_no">
@if ($errors->has('name'))
