                        ...
                        <div class="card-body">
                            <form class="form" method="post" enctype="multipart/form-data"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            <label for="userName_en">Name<i class="text-danger">*</i></label>
                                            <input type="text" id="userName_en" class="form-control"
                                                value="{{ old('userName_en') }}" name="userName_en">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            <label for="userName_bn">Name</label>
                                            <input type="text" id="userName_bn" class="form-control"
                                                value="{{ old('userName_bn') }}" name="userName_bn">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="contactNumber_en" class="form-control"
                                                value="{{ old('contactNumber_en') }}" name="contactNumber_en">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="contactNumber_bn" class="form-control"
                                                value="{{ old('contactNumber_bn') }}" name="contactNumber_bn">
